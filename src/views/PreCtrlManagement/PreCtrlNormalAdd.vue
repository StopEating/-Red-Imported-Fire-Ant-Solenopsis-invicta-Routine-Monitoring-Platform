<template>
  ...
  <div>
      <span style="width:35%;display: inline-block">区域搜索：</span>
      <el-input
      type="textarea"
      v-model="search"
      autosize
...
let search=ref()
  ...
  // 切换地图模式
  const changemap=()=>{
    router.push('/prectrlmanagement/prectrladd')
  }
  const init = (e:any) => {
    // 绘制边界
...
//   let p=[[113.284121,23.041027],[113.282579,23.039026],[113.284624,23.038308],[113.287474,23.03841],[113.287824,23.04053],[113.286706,23.04257],[113.284176,23.042711],[113.282487,23.041372],[113.282419,23.039913],[113.282505,23.038862]]
//     var p0 = [113.279735,23.042226];
// // var p1 = [116.434027, 39.941037];
// // var p2 = [116.461665, 39.941564];
// // var p3 = [116.466171, 39.937977];
// // 判断 p0 是否在 p1-p2-p3 围成的封闭区域内
// var inRing = AMap.GeometryUtil.isPointInRing(p0, p);
// console.log(inRing)
  </script>
